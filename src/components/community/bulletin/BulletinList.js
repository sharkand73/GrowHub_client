...
const BulletinList = ({bulletins, currentUser, deleteBulletin}) =>{
...
const bulletinArray = bulletins.map((bulletin, index) => {
    return(
        <li key={index}><Bulletin bulletin={bulletin} currentUser={currentUser} deleteBulletin={deleteBulletin}/></li>
    )
})
